...
train_loader = paddle.io.DataLoader(train_dataset, places=paddle.CPUPlace(), batch_size=1024, shuffle=True, num_workers=0)
...
val_loader = paddle.io.DataLoader(val_dataset, places=paddle.CPUPlace(), batch_size=1024, shuffle=True, num_workers=0)
...
from paddle.nn import Conv1D, BatchNorm1D, MaxPool1D, LayerNorm
...
class MyNet_dwt(nn.Layer):
	...
	def __init__(self, num_classes=95):
		...
		self._conv2_4 = Conv1D(512,256,3,stride=2,padding=1)
		...
		self._conv3_4 = Conv1D(512,256,3,stride=2,padding=1)
		...
		self._conv4_4 = Conv1D(512,256,3,stride=2,padding=1)
		...
		self._conv5_4 = Conv1D(512,256,3,stride=2,padding=1)
		...
		self._fc8 = Linear(in_features=64525,out_features=num_classes)
	...
	def forward(self, inputs):
		...
		#卷积
		#x1 = F.relu(self._bn1_1(self._conv1_1(x1)))#500
		#x1 = F.relu(self._bn1_2(self._conv1_2(x1)))#250
		#x1 = F.relu(self._bn1_3(self._conv1_3(x1)))#125
		#x1 = F.relu(self._bn1_4(self._conv1_4(x1)))#63
		
		x2 = F.relu(self._bn2_1(self._conv2_1(x2)))#500
		x2 = F.relu(self._bn2_2(self._conv2_2(x2)))#250
		x2 = F.relu(self._bn2_3(self._conv2_3(x2)))#125
		x2 = F.relu(self._bn2_4(self._conv2_4(x2)))#63
		
		x3 = F.relu(self._bn3_1(self._conv3_1(x3)))#500
		x3 = F.relu(self._bn3_2(self._conv3_2(x3)))#250
		x3 = F.relu(self._bn3_3(self._conv3_3(x3)))#125
		x3 = F.relu(self._bn3_4(self._conv3_4(x3)))#63
		
		x4 = F.relu(self._bn4_1(self._conv4_1(x4)))#500
		x4 = F.relu(self._bn4_2(self._conv4_2(x4)))#250
		x4 = F.relu(self._bn4_3(self._conv4_3(x4)))#125
		x4 = F.relu(self._bn4_4(self._conv4_4(x4)))#63
		
		x5 = F.relu(self._bn5_1(self._conv5_1(x5)))#500
		x5 = F.relu(self._bn5_2(self._conv5_2(x5)))#250
		x5 = F.relu(self._bn5_3(self._conv5_3(x5)))#125
		x5 = F.relu(self._bn5_4(self._conv5_4(x5)))#63
		
		#x6 = F.relu(self._bn6_1(self._conv6_1(x6)))#500
		#x6 = F.relu(self._bn6_2(self._conv6_2(x6)))#250
		#x6 = F.relu(self._bn6_3(self._conv6_3(x6)))#125
		#x6 = F.relu(self._bn6_4(self._conv6_4(x6)))#63
		
		#试一下加一层卷积
		
		
		#x_t = paddle.concat(x = [x1, x2, x3, x4, x5, x6], axis=2)#63*6=378
		x_t = paddle.concat(x = [x2, x3, x4, x5], axis=2)#63*4=252
		x_t = paddle.flatten(x_t, start_axis=1, stop_axis=-1)#这里x的shape是[batch_size,64512]，64512=1*256*252
...
paddle.summary(model_res,(1024,65,1000))
...
scheduler = CosineWarmup(lr=0.0001, step_each_epoch=57, epochs=24, warmup_steps=5, start_lr=0, end_lr=0.0001, verbose=True)
...
model.save('/home/aistudio/model/baseline_20220823_v21', True)
...
param_state_dict = paddle.load( "/home/aistudio/model/baseline_20220823_v21.pdparams")
...
img_test.to_csv('/home/aistudio/submit/result_20220823_v21.csv', index=False)
